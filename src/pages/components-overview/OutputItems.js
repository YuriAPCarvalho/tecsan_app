...
const OutputItems = () => {
  ...
  const handleSave = async () => {
    ...
    const url = itemId ? `http://191.252.212.69:3003/api/saida-item/${itemId}` : 'http://191.252.212.69:3003/api/saida-item';
  ...
  const handleProdutoIdChange = async (event) => {
    ...
    if (produtoId) {
      try {
        let response = await fetch(`http://191.252.212.69:3003/api/saida-item/produtoId/${produtoId}`);
        let data = await response.json();

        if (!data) {
          response = await fetch(`http://191.252.212.69:3003/api/saida-item/descricao/${produtoId}`);
  ...
  useEffect(() => {
    if (itemId) {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://191.252.212.69:3003/api/saida-item/${itemId}`);
  ...
  useEffect(() => {
    const fetchProduto = async () => {
      const response = await fetch('http://191.252.212.69:3003/api/produto');
      const data = await response.json();
      setProdutosId(data);
    };
  ...
  useEffect(() => {
    const fetchEstoque = async () => {
      const response = await fetch('http://191.252.212.69:3003/api/estoque');
      const data = await response.json();
      setEstoques(data);
    };
  ...
  useEffect(() => {
    const fetchSolicitante = async () => {
      const response = await fetch('http://191.252.212.69:3003/api/solicitante');
      const data = await response.json();
  ...
  useEffect(() => {
    const fetchUsuario = async () => {
      const response = await fetch('http://191.252.212.69:3003/api/usuario');
      const data = await response.json();
      setUsuarios(data);
    };
