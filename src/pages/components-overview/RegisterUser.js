...
const RegisterUser = () => {
  ...
  useEffect(() => {
    if (itemId) {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://191.252.212.69:3003/api/usuario/${itemId}`);
  ...
  const handleSave = async () => {
    ...
    const url = itemId ? `http://191.252.212.69:3003/api/usuario/${itemId}` : 'http://191.252.212.69:3003/api/usuario';
