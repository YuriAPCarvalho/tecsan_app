...
const OutputItemsList = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch('http://191.252.212.69:3003/api/saida-item');
    ...
    const fetchUsuarios = async () => {
      try {
        const responseUsuarios = await fetch('http://191.252.212.69:3003/api/usuario');
    ...
    const fetchSolicitantes = async () => {
      try {
        const responseSolicitantes = await fetch('http://191.252.212.69:3003/api/solicitante');
  ...
  const deleteItem = async (id) => {
    try {
      await fetch(`http://191.252.212.69:3003/api/saida-item/${id}`, { method: 'DELETE' });
      const response = await fetch('http://191.252.212.69:3003/api/saida-item');
      const data = await response.json();
      setOutputItems(data);
    } catch (error) {
