...
const ItemsInput = () => {
  ...
  const onSubmit = async () => {
    ...
    const url = itemId ? `http://191.252.212.69:3003/api/entrada-item/${itemId}` : 'http://191.252.212.69:3003/api/entrada-item';
  ...
  useEffect(() => {
    if (itemId) {
      const fetchData = async () => {
        try {
          const response = await fetch(`http://191.252.212.69:3003/api/entrada-item/${itemId}`);
